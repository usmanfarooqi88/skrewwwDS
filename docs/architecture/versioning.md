...
| **Registry schema version** | `lib/registry-public.ts` `metadata.schemaVersion` | Shape of `/registry.json` (currently `1.1.0`). Breaking registry field changes bump this. |
