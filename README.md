...
- **Data Table** (named "Data Grid" during discovery; canonical name finalized 2026-07-13) — narrow MVP scope approved (sorting only + external Pagination, composes Table); not yet implemented
