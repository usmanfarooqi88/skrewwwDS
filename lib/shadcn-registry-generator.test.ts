...
describe("shadcn registry generator", () => {
  ...
  it("includes the sparse warning primitive family in Foundation CSS without inventing steps", () => {
    ...
    // OSS-1B Option B: component-tier defaults (including Badge locals) ride
    // in the Foundation transport, ahead of the Shape/Surface mode blocks.
    expect(css).toMatch(/--badge-warning-text:/);
