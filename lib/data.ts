...
export const tokenColorMap: Record<string, string> = {
  ...
  "component/validation-message/text": "#CC3B37",
  "component/validation-message/error/text": "#CC3B37",
  "component/validation-message/warning/text": "#8A4F00",
  "component/validation-message/success/text": "#1F7A4D",
  "component/validation-message/info/text": "#1D4ED8",
  "color/brand/100": "#E4DEFD",
  "color/brand/500": "#6C4CF2",
  "color/brand/600": "#5638D6",
  "color/brand/700": "#4229AD",
